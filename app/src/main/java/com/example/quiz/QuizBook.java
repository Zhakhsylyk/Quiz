...
public class QuizBook {
    ...
    public static int[] images = new int [] {
            R.drawable.atom, R.drawable.electron, R.drawable.img_0512, R.drawable.img_0516, R.drawable.img_0521,
            R.drawable.img_0522, R.drawable.img_0523, R.drawable.img_0525, R.drawable.img_0526, R.drawable.img_0527,
            R.drawable.img_0528
    };
